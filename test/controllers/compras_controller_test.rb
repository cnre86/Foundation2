...
class ComprasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create compra" do
    assert_difference('Compra.count') do
      post compras_url, params: { compra: { Fecha_compra: @compra.Fecha_compra, cliente: @compra.cliente, monto: @compra.monto } }
    end
  ...
  test "should update compra" do
    patch compra_url(@compra), params: { compra: { Fecha_compra: @compra.Fecha_compra, cliente: @compra.cliente, monto: @compra.monto } }
